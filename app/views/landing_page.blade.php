    ...
    <div class="row">
      ...
      <div class="row">
        ...
        <div class="col-lg-12 text-center v-center" style="font-size:39pt;">
          <a href="http://www.facebook.com/ewoklabs"><i class="icon-facebook"></i></a>
          <a href="http://twitter.com/ewoklabs"><i class="icon-twitter"></i></a>
          <a href="https://github.com/ridvanbaluyos/AngelHackMNL2014"><i class="icon-github"></i></a>
        </div>
      </div>
    <br><br><br><br><br>
</div> <!-- /container full -->
